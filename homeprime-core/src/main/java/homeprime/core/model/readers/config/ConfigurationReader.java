...
public class ConfigurationReader {
    ...
    /**
     * File configuration.json represents settings of the application itself. This is mandatory otherwise built with
     * default settings.
     */
    public static final String CONFIGURATION_FILE_NAME = "configuration.json";
    /**
     * File things.json represents settings of the things controlled by this application. Used for HomePrime Manager.
     */
    ...
    /**
     * Get list of all the things configuration. This is used by HomePrime Manager application.
     *
     * @return
    ...
    private static Thing buildDefaultConfiguration() {
        ...
        thingConfiguration.setName("default");
