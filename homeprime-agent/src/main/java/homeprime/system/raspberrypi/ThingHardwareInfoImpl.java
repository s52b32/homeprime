...
public class ThingHardwareInfoImpl implements ThingHardwareInfo {
    ...
    public String getSerialNumber() throws ThingException {
        try {
            ...
            throw new ThingException(
                    "Failed to get RaspberryPi hardware board serial number", e);
        } catch (IOException e) {
            throw new ThingException(
                    "Failed to get RaspberryPi hardware board serial number", e);
    ...
    public String getBoardType() throws ThingException {
        try {
            ...
            throw new ThingException(
                    "Failed to get RaspberryPi hardware board type", e);
        } catch (IOException e) {
            throw new ThingException(
                    "Failed to get RaspberryPi hardware board type", e);
        } catch (InterruptedException e) {
    ...
    public float getCpuTemperature() throws ThingException {
        try {
            ...
            throw new ThingException(
                    "Failed to get RaspberryPi hardware CPU temperature", e);
        } catch (UnsupportedOperationException e) {
            throw new ThingException(
                    "Failed to get RaspberryPi hardware CPU temperature", e);
        } catch (IOException e) {
