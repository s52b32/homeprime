...
public class ThingMemoryInfoImpl implements ThingMemoryInfo {
    ...
    public long getTotalMemory() throws ThingException {
        try {
            ...
            throw new ThingException(
                    "Failed to get RaspberryPi total memory", e);
        } catch (IOException e) {
            throw new ThingException(
                    "Failed to get RaspberryPi total memory", e);
    ...
    public long getUsedMemory() throws ThingException {
        try {
            ...
            throw new ThingException(
                    "Failed to get RaspberryPi used memory", e);
        } catch (IOException e) {
            throw new ThingException(
                    "Failed to get RaspberryPi used memory", e);
        } catch (InterruptedException e) {
    ...
    public long getFreeMemory() throws ThingException {
        try {
            ...
            throw new ThingException(
                    "Failed to get RaspberryPi free memory", e);
        } catch (IOException e) {
            throw new ThingException(
                    "Failed to get RaspberryPi free memory", e);
        } catch (InterruptedException e) {
    ...
    public long getSharedMemory() throws ThingException {
        try {
            ...
            throw new ThingException(
                    "Failed to get RaspberryPi shared memory", e);
        } catch (IOException e) {
            throw new ThingException(
                    "Failed to get RaspberryPi shared memory", e);
        } catch (InterruptedException e) {
