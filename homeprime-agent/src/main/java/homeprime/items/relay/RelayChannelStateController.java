...
public interface RelayChannelStateController {
     ...
     *        relay channel data
     * @param newState
     *        state to be set to channel pin
     */
    void setChannelState(RelayChannel relayChannelData, boolean newState) throws ThingException;

    /**
     * Initialize default states for relay related pins. If relay channel is in NC mode, default
     * state will result that connected device is in OFF state i.e. disconnected.
     * 
